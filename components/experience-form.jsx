  ...
  return (
    (<Card>
      <CardHeader>
        ...
        <CardDescription>Add your professional experience to your CV</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {cv.experience.length === 0 ? (
          <div className="text-center py-4">
            <p className="text-muted-foreground mb-4">No experience entries yet. Add your first work experience.</p>
          ...
          cv.experience.map((experience, index) => (
            <Card key={index} className="border border-muted">
              <CardHeader className="p-4 pb-2 flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="text-base">{experience.position || "New Experience Entry"}</CardTitle>
                  {experience.company && (
                    <CardDescription>
                      {experience.company}
