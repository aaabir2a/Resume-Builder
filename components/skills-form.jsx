  ...
  return (
    (<Card>
      <CardHeader>
        ...
        <CardDescription>Add your skills and proficiency levels to your CV</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {cv.skills.length === 0 ? (
          <div className="text-center py-4">
            <p className="text-muted-foreground mb-4">No skills added yet. Add your first skill.</p>
